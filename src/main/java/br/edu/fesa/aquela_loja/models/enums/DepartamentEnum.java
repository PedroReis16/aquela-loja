...
public enum DepartamentEnum {
    ...
    PERIFERICOS("Periféricos", Set.of(CABOS_E_ADAPTADORES, GABINETES, HEADSETS, MESA_DIGITALIZADORA, MOUSE, MOUSE_PAD, SUPORTES, TECLADO, WEBCAM_E_VIDEOCONFERENCIA)),
    COMPUTADORES("Computadores", Set.of(IMPRESSORAS, MONITORES, NOTEBOOKS, PC, SCANNERS)),
    GAMES("Games", Set.of(ACESSORIOS_GAMER, NINTENDO, PLAYSTATION, PORTATEIS, SIMULADORES, XBOX)),
    TELEVISORES("Televisores", Set.of(ACESSORIOS_PARA_TVS, SMART_TV, TV_4K, TV_8K, TV_LED)),
    ...
    ELETRODOMESTICOS("Eletrodomésticos", Set.of(COIFAS_E_DEPURADORES, COOKTOP, FOGOES, FORNOS, GELADEIRAS));
